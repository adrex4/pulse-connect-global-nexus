  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full flex flex-col">
        <Card className="flex-1 flex flex-col shadow-lg border-0 bg-white overflow-hidden m-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-sm text-blue-100 flex-wrap">
                        <Badge 
                          className={`${getScopeColor(group.scope)} text-white flex items-center gap-1 transition-colors px-3 py-1`}
                        >
                  ...
                  <p className="text-blue-100 text-sm leading-relaxed">{group.description}</p>
                </div>
              </div>
                      ...
                      {pinnedMessages.map((msg) => (
                        <div key={msg.id} className="bg-white p-3 rounded-lg border border-amber-200 shadow-sm">
                          <div className="flex items-start justify-between">
                            ...
                            <span className="text-xs text-amber-600">{formatTime(msg.timestamp)}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                <div className="space-y-6 py-4">
                    ...
                    return (
                      <div key={message.id}>
                        ...
                        <div className={`flex ${message.userId === user.id ? 'justify-end' : 'justify-start'}`}>
                          <div className="max-w-xs lg:max-w-2xl group relative">
                            <div className={`px-4 py-3 rounded-2xl shadow-sm transition-all duration-200 hover:shadow-md relative ${
                              isAnnouncement 
                              ...
                              {message.userId !== user.id && (
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-6 h-6 bg-gradient-to-r from-green-400 to-blue-400 rounded-full flex items-center justify-center text-xs font-bold text-white">
                  ...
                  {typingUsers.length > 0 && (
                    <div className="flex justify-start">
                      <div className="bg-white text-gray-600 px-4 py-3 rounded-2xl shadow-sm border max-w-xs">
                ...
                <ScrollArea className="flex-1">
                  <div className="p-4 space-y-3">
                    {[
                      ...
                      <div key={index} className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors group">
                        <div className="relative">
